...
public class HopThitSer implements InHopThitSer{
    ...
    public ArrayList<HopThitViewModel> layDanhSachHopThit(){
        ...
        for (HopThit ht : listHT) {
            view.add(new HopThitViewModel(stt, ht.getId(), ht.getIDLoaiThit(), ht.getTenLoaiThit(), ht.getTrongLuong(), ht.getSoLuong(), ht.getNgaySanXuat().toString(), ht.getTongGia()));
            stt++;
        }
        return view;
    }

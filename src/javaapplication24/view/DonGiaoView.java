...
public class DonGiaoView extends javax.swing.JPanel {
    ...
    public boolean ValidateDGCN() {
        if (lbIDDG.getText().equals("") || lbIDHD.getText().equals("") || lbIDVVC.getText().equals("") ) {
            JOptionPane.showMessageDialog(this, "Vui lòng chọn đơn giao muốn cập nhật");
            return false;
        }
    ...
    private void initComponents() {
        ...
        cboTinhTrang.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Đang giao", "Đã giao", "Đã hủy" }));
        ...
        btnVanChuyen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication24/image/truck.png"))); // NOI18N
        ...
        btnReSet.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication24/image/reset.png"))); // NOI18N
    ...
    private void btnSuaDGActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaDGActionPerformed
       if(ValidateDGCN()){ String idDG = lbIDDG.getText();
